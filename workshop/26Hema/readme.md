...
| **No.** | **Aktiviti** | **Penerangan** |
| :-----: | :-------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------- |
|    5    | [Modul Latihan AI: Prompt Engineering untuk Penghasilan Kandungan & Infografik](./materials/imej.md)     | Menggunakan AI untuk mengekstrak, merumus dan mentafsir maklumat daripada dokumen penyelidikan atau dasar.                  |
