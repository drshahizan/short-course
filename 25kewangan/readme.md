...
# PROGRAM PENETAPAN KANDUNGAN LAPORAN TAHUNAN DAN PENYATA KEWANGAN UTM 2024
 ...
 <img src="imej/G5.jpeg" alt="Image Alt Text"  height="350">
...
<a href="https://drive.google.com/file/d/1iA2wFZ8N5QT3wxgHkFx33dE9B3e9mYZk/view?usp=drive_link">
 <img src="imej/LT2022.png" alt="Image Alt Text"  height="350">
</a>
<a href="https://drive.google.com/file/d/1Aq93ZmcijeMmJ-Cy821lwHV0fSb84ZIb/view">
 <img src="imej/LT2021.png" alt="Image Alt Text"  height="350">
</a>
...
| **No** | **Latihan** |
|--------|------------|
| 1. | **[Eksplorasi Alat AI untuk Penulisan Laporan Tahunan](latihan/lat1.md) 📊** <br>📌 **Tujuan:** Memahami kelebihan dan kekurangan ChatGPT, Google Gemini, dan Microsoft Copilot dalam penulisan laporan tahunan. <br> 📝 **Aktiviti:** Menggunakan AI untuk menjana draf pendahuluan Laporan Tahunan UTM 2024 dan membandingkan hasilnya dengan laporan tahun sebelumnya. |
| 2. | **[Pemilihan Alat AI yang Tepat untuk Penyata Kewangan](latihan/lat2.md) 🎯** <br>📌 **Tujuan:** Menentukan alat AI yang paling sesuai untuk menyediakan penyata kewangan tahunan. <br> 📝 **Aktiviti:** Menguji AI dalam menganalisis komponen kewangan seperti Penyata Kedudukan Kewangan, Penyata Pendapatan, dan Aliran Tunai menggunakan data hipotetikal. |
| 3. | **[Menulis Prompt yang Berkesan untuk AI dalam Konteks Laporan Tahunan](latihan/lat1.md) 🔑** <br>📌 **Tujuan:** Menghasilkan arahan (prompt) yang lebih spesifik dan berkesan dalam menjana laporan tahunan UTM. <br> 📝 **Aktiviti:** Menulis dan membandingkan output AI berdasarkan variasi prompt yang berbeza untuk bahagian laporan seperti Ucapan Naib Canselor dan Ringkasan Pencapaian Akademik. |
| 4. | **[Membandingkan Output AI Berdasarkan Variasi Prompt dalam Penyata Kewangan](latihan/lat1.md) 📋** <br>📌 **Tujuan:** Memahami kesan variasi prompt terhadap kualiti output AI dalam konteks penyediaan penyata kewangan. <br> 📝 **Aktiviti:** Menggunakan tiga tahap prompt (umum, sederhana, spesifik) untuk menjana analisis kewangan UTM 2024 dan membandingkan ketepatan serta relevansi output. |
| 5. | **[Menambah Baik Output AI Menggunakan Iterasi Prompt](latihan/lat1.md) 🔄** <br>📌 **Tujuan:** Memperbaiki hasil laporan AI melalui iterasi prompt bagi memastikan output yang lebih tepat dan berkualiti. <br> 📝 **Aktiviti:** Menggunakan AI untuk menghasilkan laporan awal, menyesuaikan prompt berdasarkan kekurangan output, dan mengulang proses sehingga mencapai hasil terbaik. |
| 6. | **[AI vs Manusia – Menilai Ketepatan Laporan](latihan/lat1.md) 🧐** <br>📌 **Tujuan:** Membandingkan laporan AI dengan laporan manusia untuk mengenal pasti kelemahan AI. <br> 📝 **Aktiviti:** Menggunakan laporan tahunan UTM tahun sebelumnya sebagai rujukan, menjana laporan AI berdasarkan data yang sama, dan menilai perbezaan dari segi ketepatan, struktur, dan keabsahan maklumat. |
| 7. | **[AI & Imej – Menjana Kapsyen Daripada Gambar](latihan/lat1.md) 🖼️📜** <br>📌 **Tujuan:** Menguji kebolehan AI dalam memahami dan menerangkan imej berkaitan laporan tahunan. <br> 📝 **Aktiviti:** Menggunakan gambar daripada laporan UTM tahun sebelumnya, menjana kapsyen AI, dan membandingkan ketepatan dengan kapsyen asal. |
| 8. | **[AI & Data – Menjana Analisis Daripada Graf](latihan/lat1.md) 📊🔍** <br>📌 **Tujuan:** Menganalisis kemampuan AI dalam membaca dan menerangkan graf kewangan. <br> 📝 **Aktiviti:** Memberikan graf kewangan daripada laporan UTM 2023 kepada AI dan membandingkan analisis yang dijana dengan analisis asal laporan tahunan. |
| 9. | **[Menggunakan AI untuk Menganalisis Kesalahan dalam Laporan](latihan/lat1.md) ❌✅** <br>📌 **Tujuan:** Memahami bagaimana AI boleh digunakan untuk menyemak dan membetulkan laporan kewangan. <br> 📝 **Aktiviti:** Menggunakan laporan tahunan UTM yang diubah suai dengan kesalahan fakta atau format, meminta AI untuk mengesan kesalahan, dan menilai ketepatan pembetulan yang dicadangkan. |
| 10. | **[AI dan Keaslian Penulisan – Mengesan Bias atau Ketidaktepatan](latihan/lat1.md) 📢** <br>📌 **Tujuan:** Menganalisis sama ada AI menghasilkan kandungan yang tepat dan bebas daripada bias. <br> 📝 **Aktiviti:** Menjana ringkasan pencapaian UTM 2024 menggunakan AI dan menilai sejauh mana ia bersifat objektif serta tidak mengandungi maklumat yang mengelirukan. |
| 11. | **[Penggunaan Napkin.ai dalam Laporan Tahunan & Penyata Kewangan UTM 2024](latihan/lat11_napkin.md) 📊🧠**<br> 📌 Latihan praktikal untuk menggunakan Napkin.ai secara menyeluruh dalam menjana visualisasi data, analisis kewangan, dan laporan tahunan bagi meningkatkan kejelasan dan impak laporan.|
